...
namespace Game
{
    internal sealed class PlayerMoveController: IInitialize, IExecute, ICleanUp
    {
        ...
        public PlayerMoveController(IPlayer player, Transform playerTransform, PlayerBodyData playerData, (IUserInputProxy inputHorizontal, IUserInputProxy inputVertical, IUserInputProxy inputMouseX, IUserInputProxy inputMouseY, IUserButtonInputProxy inputJump) input, Camera camera)
        {
