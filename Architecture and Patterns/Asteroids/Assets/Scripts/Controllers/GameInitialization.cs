...
namespace Asteroids
{
    internal sealed class GameInitialization
    {
        ...
        public GameInitialization(Controllers controllers, Data data)
        {
            ...
            controllers.Add(new BulletInitialization(bulletObjectPool, playerInitialization.GetPlayer().GetTransform().GetChild(0).GetChild(0), inputInitialization.GetInput()));
